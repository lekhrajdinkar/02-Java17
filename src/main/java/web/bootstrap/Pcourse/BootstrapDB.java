package web.bootstrap.Pcourse;

import web.DAO.Pcourse.CategoryDAO;
import web.DAO.Pcourse.CourseDAO;
...
public class BootstrapDB implements CommandLineRunner {
    ...
    void LoadDB(){
        ...
        // Instructor
        Instructor i1 = Instructor.builder().name("Anna liu").email("al@ggg.com").build();
        Instructor i2 = Instructor.builder().name("lekhraj Dibkar").email("ld@ggg.com").build();
        Instructor i3 = Instructor.builder().name("Julii Liu").email("jl@ggg.com").build();
